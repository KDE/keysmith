...
public:
    ...
    void acceptTotpTokens(const QString &token, const QString &nextToken, const QDateTime &validFrom, const QDateTime &validUntil);
...
private:
    bool validateGenericNewToken(const QString &name, const QString &issuer, const QString &secret, uint tokenLength) const;
